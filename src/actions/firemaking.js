module.exports = {
  ...
  mapping: {
    log: {
      name: 'log', level: 1, xp: 40, baseTime: 21,
    },
    oak: {
      name: 'oak log', level: 15, xp: 60, baseTime: 22,
    },
    willow: {
      name: 'willow log', level: 30, xp: 90, baseTime: 23,
    },
    maple: {
      name: 'maple log', level: 45, xp: 135.5, baseTime: 24,
    },
    yew: {
      name: 'yew log', level: 60, xp: 202.5, baseTime: 25,
    },
  },
